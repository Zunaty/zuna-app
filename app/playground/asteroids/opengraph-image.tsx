...
export const alt = `Asteroids — ${site.name}`;
export const size = playgroundOgSize;
export const contentType = playgroundOgContentType;

export default function AsteroidsOpenGraphImage() {
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ fontSize: 72, fontWeight: 700, marginTop: 16, lineHeight: 1.05 }}>Asteroids</div>
      <div style={{ fontSize: 30, marginTop: 24, opacity: 0.85, maxWidth: 900 }}>
        Wrap-around arena shooter — rotate, thrust, and split the rocks.
      </div>
    </div>,
    { ...size },
  );
