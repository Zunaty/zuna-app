...
| **Lunar Lander**            | Planned  | `/playground/lunar-lander` — Earth-to-Moon three-phase mission; ships after Asteroids; [spec](../improvements/active/lunar-lander.md)                  |
| **Asteroids**               | Building | `/playground/asteroids` — Classic playable; Roguelite loadout/field drafts next; [spec](../improvements/active/asteroids.md)                           |
